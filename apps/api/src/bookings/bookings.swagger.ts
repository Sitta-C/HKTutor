  ...
  return applyDecorators(
    ...
    ApiOkResponse({
      ...
      schema: {
        ...
        items: { $ref: getSchemaPath(BookingQuoteResponseDto) },
        type: 'object',
      },
    }),
    ApiBadRequestResponse({
  ...
  return applyDecorators(
    ...
    ApiOkResponse({
      ...
      schema: {
        ...
        items: { $ref: getSchemaPath(MyBookingsResponseDto) },
        type: 'object',
      },
    }),
    ApiBadRequestResponse({
  ...
  return applyDecorators(
    ...
    ApiOkResponse({
      ...
      schema: {
        ...
        items: { $ref: getSchemaPath(BookingDetailResponseDto) },
        type: 'object',
      },
    }),
    ApiBadRequestResponse({
  ...
  return applyDecorators(
    ...
    ApiOkResponse({
      ...
      schema: {
        ...
        items: { $ref: getSchemaPath(TutorBookingsResponseDto) },
        type: 'object',
      },
    }),
    ApiBadRequestResponse({
