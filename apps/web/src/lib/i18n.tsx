...
const translations = {
  en: {
    ...
    register: {
      ...
      tutor: 'Tutor',
      policy:
        'I agree to the HKTutor privacy policy and understand how my account information is used.',
  ...
  th: {
    ...
    register: {
      ...
      student: 'นักเรียน',
      tutor: 'ติวเตอร์',
      policy: 'ฉันยอมรับนโยบายความเป็นส่วนตัวของ HKTutor และเข้าใจการใช้ข้อมูลบัญชีของฉัน',
      submit: 'สร้างบัญชี',
