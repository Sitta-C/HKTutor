  ...
  en: {
    ...
    dashboard: {
      ...
      availability: {
        ...
        thisWeek: 'This week',
        weekOf: 'Week of {date}',
        weekDescription: 'Adjacent ranges are allowed. Overlapping ranges are rejected.',
        openSlots: 'Open slots',
        openSlotsHelp: 'Future and available',
        reservedSlots: 'Reserved slots',
        reservedSlotsHelp: 'Pending or confirmed booking',
        teachingHours: 'Teaching hours',
        teachingHoursHelp: 'Shown for this week',
        hour: '{count} hour',
        hours: '{count} hours',
        minute: '{count} minute',
        ...
        date: 'Date',
        calendarLabel: 'Choose an availability date',
        ...
        duration: '{hours} hour',
        durationPlural: '{hours} hours',
        openDetail: 'No active booking',
        reservedDetail: 'Pending or confirmed booking',
        ...
        reservedHelpTitle: 'Why a reserved slot cannot be deleted',
        reservedHelp:
          'A pending or confirmed booking owns that reservation. Canceling or completing the booking changes availability through booking rules.',
  ...
  th: {
    ...
    dashboard: {
      ...
      availability: {
        ...
        weekDescription: 'ช่วงเวลาที่ต่อกันสร้างได้ แต่ช่วงเวลาที่ซ้อนกันจะถูกปฏิเสธ',
        openSlots: 'ช่วงเวลาว่าง',
        openSlotsHelp: 'ในอนาคตและยังจองได้',
        reservedSlots: 'ช่วงเวลาที่ถูกจอง',
        reservedSlotsHelp: 'มีการจองที่รอหรือยืนยันแล้ว',
        teachingHours: 'ชั่วโมงสอน',
        teachingHoursHelp: 'แสดงสำหรับสัปดาห์นี้',
        hour: '{count} ชั่วโมง',
        hours: '{count} ชั่วโมง',
        minute: '{count} นาที',
        minutes: '{count} นาที',
        ...
        durationPlural: '{hours} ชั่วโมง',
        openDetail: 'ไม่มีการจองที่ใช้งานอยู่',
        reservedDetail: 'มีการจองที่รอหรือยืนยันแล้ว',
        ...
        reservedHelpTitle: 'เหตุผลที่ลบช่วงเวลาที่ถูกจองไม่ได้',
        reservedHelp:
          'การจองที่รอหรือยืนยันแล้วกำลังใช้ช่วงเวลานั้น การยกเลิกหรือจบคลาสจะเปลี่ยนสถานะผ่านกฎของการจอง',
