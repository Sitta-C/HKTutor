  ...
  en: {
    ...
    dashboard: {
      ...
      booking: {
        ...
        submissionInProgress: 'A booking request is already being sent.',
        status: 'Status',
        pending: 'PENDING',
        confirmed: 'CONFIRMED',
        completed: 'COMPLETED',
        ...
        serverAmountNote: 'Amounts are confirmed by the server.',
        ...
        requestCreatedStatus:
          'Your request was created as {status}. The selected time is now reserved.',
        tutorAndSubject: 'Tutor and subject',
  ...
  th: {
    ...
    dashboard: {
      ...
      booking: {
        ...
        serverAmountNote: 'ยอดเงินยืนยันโดยเซิร์ฟเวอร์',
        hourlyRate: 'ค่าบริการต่อชั่วโมง',
        sendingRequest: 'กำลังส่งคำขอ…',
        sendBookingRequest: 'ส่งคำขอจอง',
        changeTime: 'เปลี่ยนเวลา',
        bookingRequestSent: 'ส่งคำขอจองแล้ว',
        requestCreatedStatus: 'สร้างคำขอเป็นสถานะ {status} แล้ว เวลาที่เลือกถูกกันไว้เรียบร้อย',
        tutorAndSubject: 'ติวเตอร์และวิชา',
