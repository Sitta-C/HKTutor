...
| Time                                  | Store/compare UTC and keep form values as Gregorian ISO; display Asia/Bangkok and explicit date/time. English uses the Gregorian calendar and Thai uses the Buddhist calendar. Use the same time boundary for cards, filters and reports; switching EN/TH changes presentation only. |
