...
| `/dashboard/listings/new`              | `app/dashboard/listings/new/page.tsx`, `components/listings/tutor-listing-editor.tsx`                                    | Form and validation exist; subject/grade loading is blocked by the missing T21 catalogs | Tutor listing mutation exists; selector catalogs are unavailable         |
| `/dashboard/listings/[listingId]/edit` | `app/dashboard/listings/[listingId]/edit/page.tsx`, `components/listings/tutor-listing-editor.tsx`                       | Editor exists; owned listing loads, but selectors still require the T21 catalogs        | Ownership-checked listing API exists; selector catalogs are unavailable  |
...
matching production controller. Other domain sections specify proposed contracts and must remain
labelled as unavailable until matching controllers and clients exist.
